...
(function() {
  ...
  predefinedSymbolsInGlobalScope_doNotTrackInDependencies = ["rationalize", "abs", "e", "i", "pi", "sin", "cos", "roots", "integral", "derivative", "defint", "sqrt", "eig", "cov", "deig", "dcov", "float"];
...
function getColumnsM(matrix){
	console.log(matrix);
	Algebrite.run('A='+matrix);
	//console.log(Algebrite.run("shape([[1,2]])").toString());
	console.log(Algebrite.shape('A'));
	//console.log(Algebrite.run("shape("+matrix+")").toString());
	// var sizeA = (new Function("return [" + Algebrite.shape('A')+ "];")());
	//var size=	(new Function("return " + Algebrite.run(matrix).toString+ ";")())
	//console.log(matrix);
	return 1;
}
 ...
 * @param {string} Matrix - [[12,87]]
 * @return{int} columns of Matrix - 1
 */
function getRowsM(matrix){
 var size=	(new Function("return " + Algebrite.shape('A')+ ";")())
	return size[0];
}
...
/**
 * TODO: set matrix A before getting the size of it!
 * Calculates the controllability matrix: Q_S=[A,AB,A^n-1B] 
