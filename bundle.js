...
(function() {
  ...
  inv = function() {
    var a, accumulator, eachEntry, i, i1, n, o, ref, ref1;
    i = 0;
    n = 0;
    save();
    p1 = pop();
  ...
  shape = function() {
    ...
    if (!istensor(p1)) {
      if (!iszero(p1)) {
        stop("[shape] transpose: tensor expected, 1st arg is not a tensor");
      }
      push(zero);
      restore();
      return;
  ...
  Eval_size = function() {
    ...
    Eval();
    p1 = pop();
    console.log("coffee:" + p1);
    console.log(shape("[[1,2],[1,2]]"));
    push_symbol(SIZE);
    push(p1);
    return list(2);
  };
  ...
  symbolsinfo = function() {
    ...
    for (i = l1 = ref2 = NIL + 1, ref3 = symtab.length; ref2 <= ref3 ? l1 < ref3 : l1 > ref3; i = ref2 <= ref3 ? ++l1 : --l1) {
      ...
      symtabi = symtab[i] + "";
      bindingi = binding[i];
      symbolsinfoToBePrinted += "" + symtabi + ": " + countsize(binding[i]) + "  " + bindingi + "\n";
    }
    symbolsinfoToBePrinted = firstline + symbolsinfoToBePrinted;
